...
class _HomeLayoutState extends State<HomeLayout> {
                ...
                Container(
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children:
                      [
                        defaultTextFormField(label: "Title Task",
                        ...
                        defaultTextFormField(label: "Task Time",
                        ...
                        SizedBox(height: 20.0,),
                        defaultTextFormField(label: "Task Date",
      ...
      onCreate: (database, version)
        {
          ...
          database.execute("create table tasks (id INTEGER PRIMARY KEY,title TEXT, date TEXT, time TEXT, status TEXT )").
           then((value) => print("the table is created")).catchError((onError){
...
})async
  {
    return  await dataBase.transaction((txn)async {
       ...
       then((value) => print("$value inserted successfully")).catchError((onError){
         print(onError.toString());
       });
    });
